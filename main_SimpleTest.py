...
class MIMIC_simple_test(Dataset):
    def __init__(self,data,isTrain=False):
        self.data = pickle.load(open(data,'rb'))
        self.ecg = self.data['samples']
...
def main(args):
    ...
    test_set = MIMIC_simple_test(data='SimpleTest/MIMIC_test_data/Simple_data_MIMIC.pkl',isTrain=False)
