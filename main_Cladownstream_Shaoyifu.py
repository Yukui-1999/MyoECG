...
from data.dataset import ShaoyifuCardiomyopathyDataset
...
def main(args):
    ...
    all_set = ShaoyifuCardiomyopathyDataset(table_path='/home/dingzhengyao/Work/ECG_CMR_TAR/ECG_CMR_Rework/ECG_CMR_CMAI/data/ShaoyifuData/FirstWholeSummary0330/extval_binary_patient_unique_with_quality.csv',
                                            task='binary', isTrain=False, args=args)
    # all_set = ShaoyifuCardiomyopathyDataset(table_path='/home/dingzhengyao/Work/ECG_CMR_TAR/ECG_CMR_Rework/ECG_CMR_CMAI/data/ShaoyifuData/process0515/results/extval_binary_patient_unique_with_quality_cleaned.csv',
    #                                         task='binary', isTrain=False, args=args)
