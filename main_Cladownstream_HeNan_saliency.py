...
import pandas as pd
import pickle
from engine_Caldownstream import train_one_epoch, evaluate, test_evaluate_saliency
...
def get_args_parser():
    ...
    parser.add_argument('--saliency_dir', default='/home/dingzhengyao/Work/ECG_CMR_TAR/ECG_CMR_Rework/ECG_CMR_CMAI/Explain/results/Bin_saliency_maps')
    parser.add_argument('--saliency_mode', default='integrated_gradients', type=str, help='saliency mode')
    # data
    ...
    parser.add_argument('--ECG_length', default=10000, type=int, help='ECG length')
    ...
    parser.add_argument('--cal_popular_index', action='store_true', help='cal_popular_index')
    return parser
